...
{
    public static Microsoft.Extensions.DependencyInjection.IServiceCollection Configure<T>(this Microsoft.Extensions.DependencyInjection.IServiceCollection services, Microsoft.Extensions.Configuration.IConfiguration configuration)
    {
        if (typeof(T) == typeof(MyOptions))
        {
            services.Configure<MyOptions>(o => BindCore(configuration, o));
        }
        else if (typeof(T) == typeof(ConfigurationOptions))
        {
            services.Configure<ConfigurationOptions>(o => BindCore(configuration, o));
        }
        return services;
    }
